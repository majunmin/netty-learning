package com.majm.rpc.serialize.kyro;
...
import com.majm.rpc.exception.SerializeException;
...
public class KryoSerializer implements Serializer {
    ...
    @Override
    public byte[] seralize(Object obj) {
    ...
    @Override
    public <T> T deSeralize(byte[] bytes, Class<T> clazz) {
